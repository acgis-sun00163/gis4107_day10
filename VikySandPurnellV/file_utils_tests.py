...
def test_write_to_file():
    file_name = os.path.join(os.path.dirname(os.path.abspath(__file__)),
                            "data",
                            "TestFile.txt")
    content= "It's good time for skiing !"

    desc ="Write the new content to the txt file"
    expected = "It's good time for skiing !"
    actual = fu.write_to_file(file_name,content)
    print_test_results(fu.write_to_file,desc, expected, actual)
